            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-2xl p-6 mb-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm font-mono text-white font-bold">{team.receiptData.receiptNumber}</p>
                </div>
              </div>
              <button
                onClick={() => downloadReceipt(team.receiptData!)}
                className="w-full bg-white/10 hover:bg-white/20 border border-white/10 text-white font-bold py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 text-sm"
              >
            ...
            <div className="space-y-6">
              ...
              {team.receiptData && (
                <div className="pt-4 border-t border-white/5">
                  <p className="text-[10px] text-slate-600 uppercase font-bold tracking-widest mb-3">Payment Receipt</p>
                  <button
                    onClick={() => downloadReceipt(team.receiptData!)}
                    className="w-full bg-green-500/10 hover:bg-green-500/20 border border-green-500/20 text-green-400 font-bold py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 text-sm"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
                  ...
                  <p className="text-[9px] text-slate-600 text-center mt-2 font-mono">{team.receiptData.receiptNumber}</p>
                </div>
              )}
            </div>
          </div>
